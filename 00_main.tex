...
\hypersetup{pdftitle={Anomaliedetektion_masterthesis_wiume},pdfauthor={Yannick Wiume}} % Fill out to include PDF metadata for the author and title of the book
\date{\today}
...
\newcommand\tab[1][1.54cm]{\hspace*{#1}}
...
%	TITLE PAGE
%----------------------------------------------------------------------------------------
\createTikZTitlePage{Maschinenbau und\\Mechatronik}{{\huge\textbf{Anomaliedetektion in\\ Produkterprobungsdaten\\ von ADAS Steuergeräten}}\newline{\\\LARGE\textbf{Masterthesis}\newline \\\normalsize{Bearbeitungszeitraum: \tab[0.18cm]01.12.2022 bis 31.05.2023\\ \newline Erstkorrektor: \tab[1.7cm] Prof. Dr. rer. nat. Helfrich-\\\tab[4.6cm]Schkarbanenko\\ Zweitkorrektor: \tab Prof. Dr.-Ing. Burkhart}}}{Yannick Wiume}

%\createTikZTitlePage{{Maschinenbau und \newline Mechatronik}\\{\huge\textbf{Anomaliedetektion in\\ Produkterprobungsdaten\\von ADAS Steuergeräten}}\newline{\small\\Bearbeitungszeitraum: \tab[0.2cm]01.12.2022 bis 31.05.2023\\ \newline Erstkorrektor: \tab[1.6cm] Prof. Dr.-Ing. Schkarbanenko\\ Zweitkorrektor: \tab Prof. Dr.-Ing. Burkhart}}{Yannick Wiume}


\includepdf[pages=1]{Werkstudent}
\input{01_Erklaerung}
...
\noindent \textsc{Published by Yannick Wiume}\\ % Publisher
...
%\chapterimage{Pictures/stage-bosch-logo-16x9.jpg} % Table of contents heading image
